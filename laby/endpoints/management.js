/**
* The MAnagement Dashboard Endpoint for the Laby server
**/
// Even though an express reference was created by omega.js entrypoint
var express = require('express');
var managementDashboardRouter = express.Router();

// Storage route.   http://$HOSTNAME/storage/v1/templates/4
managementDashboardRouter.get('/admin', function(request, response, next) {
  /**
 ...
 console.log(" >>>>>>>>>>>>>>>>>>>>>  this is the management endpoint : I am under development, not available for end users yet ");
